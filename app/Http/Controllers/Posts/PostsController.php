...
class PostsController extends Controller
{
    ...
    {
        $request->validate([
            "nama" => "required|string|max:255|unique:App\Models\Backend\Posts,kode",
        ...
        return Redirect::route('posts')->with('message', "Data berhasil disimpan");
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return Redirect::route('posts')->with('message', "Data berhasil di update");
    }
    ...
    public function destroy(string $id)
    {
        ...
        $post->delete();
        return Redirect::route('posts')->with('message', "Data berhasil dihapus");
    }
}
